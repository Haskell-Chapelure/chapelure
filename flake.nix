{
  description = "chapelure: beautiful compiler errors";
  inputs = {
    ...
    flake-utils.lib.eachSystem [ "x86_64-linux" "x86_64-darwin" "aarch64-darwin" ] (system:
      let
        ...
        project = returnShellEnv:
          pkgs.haskell.packages.ghc921.developPackage {
            ...
            overrides = self: super: with pkgs.haskell.lib; {
              ...
              hsluv-haskell = pkgs.haskell.lib.dontCheck
                (self.callHackage "hsluv-haskell" "0.1.0.0" { });
            };
            modifier = drv:
